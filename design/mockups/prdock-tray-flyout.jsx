...
// Purple-slate palette from the PRDock styling guide
const palette = {
  light: {
    page: "#E8E4F0",
    surface: "#ffffff",
...
export default function PRDockTrayMockup() {
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {/* PRDock tray icon — the star of the show */}
          <button
            ref={trayRef}
            ...
            title={`PRDock — ${failing} failing, ${pending} running`}
          >
            <div
              style={{
                width: 22,
