...
export function FirstRunOverlay({ message, ctaLabel, onCtaClick, onDismiss }: FirstRunOverlayProps) {
  return (
    <div className="relative mx-2 mb-3 animate-[fadeSlideIn_0.2s_ease-out] rounded-xl border border-[var(--color-modal-border)] bg-[var(--color-modal-bg)] px-4 py-4 shadow-lg backdrop-blur-sm">
      ...
      <p className="pr-6 text-sm font-medium text-[var(--color-text-primary)]">
        {message}
      </p>

      <button
        onClick={() => { onCtaClick(); onDismiss(); }}
