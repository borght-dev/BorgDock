    ...
    <div>
      ...
      >
        ...
        {!node.isFolder && (
          ...
          >
            <svg className="h-3.5 w-3.5" viewBox="0 0 16 16" fill={node.isFavorite ? 'currentColor' : 'none'} stroke="currentColor" strokeWidth="1.2">
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-1.5 px-1">
                  {favoriteQueries.map((q) => (
                    ...
                    >
                      <svg className="h-3 w-3 text-[var(--color-status-yellow)]" viewBox="0 0 16 16" fill="currentColor">
                        <path d="M8 1.5l2 4.1 4.5.6-3.3 3.2.8 4.5L8 11.7l-4 2.2.8-4.5L1.5 6.2l4.5-.6z" />
                      </svg>
                      {q.name}
                    </button>
