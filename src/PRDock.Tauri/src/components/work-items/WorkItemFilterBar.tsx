  ...
  return (
    <div className="space-y-2 border-b border-[var(--color-subtle-border)] px-3 py-2.5">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <svg className="h-3.5 w-3.5 shrink-0 text-[var(--color-text-muted)]" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.3">
            <rect x="2" y="3" width="12" height="10" rx="1.5" />
            <path d="M5 6h6M5 9h4" />
          </svg>
          <span className="truncate">
            {selectedQueryName || 'Select a query...'}
          </span>
          <svg className="ml-auto h-3 w-3 shrink-0 text-[var(--color-text-ghost)]" viewBox="0 0 16 16" fill="currentColor">
            <path d="M4 6l4 4 4-4" />
          </svg>
        </button>
        <button
        ...
        >
          <svg className="h-4 w-4" viewBox="0 0 16 16" fill="none" stroke="currentColor" strokeWidth="1.5">
            <path d="M2 8a6 6 0 0110.9-3.5M14 2v4h-4M14 8a6 6 0 01-10.9 3.5M2 14v-4h4" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        </button>
      </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex gap-1">
          ...
          >
            Tracked
            {trackedCount > 0 && (
              <span className="ml-1 opacity-75">{trackedCount}</span>
            )}
          </button>
          <button
          ...
          >
            Working
            {workingOnCount > 0 && (
              <span className="ml-1 opacity-75">{workingOnCount}</span>
            )}
          </button>
        </div>
      </div>
